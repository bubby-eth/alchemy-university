...
const balances = new Map([
    ["0xB751181881B238BC03AFF2F05238523E5153CE7C", 100], // bob
    ["0x2691DFF0EEAE64F2BF99B775A5E8A6BD0C1D01A3", 50], // alice
    ["0x859769B97161E02C983A49D6B3DCCBECE32431E8", 75], // charles
]);
...
app.post("/send", (req, res) => {
    ...
    const sender = '0x' + crypto.pubKeyToAddress(pubKey);
